...
# Compute the overall mean and standard deviation for each measurement column
...
# Compute the mean and standard deviation for each measurement column, separately for each species
...
# We look for the measurement with the least overlap in standard deviations
